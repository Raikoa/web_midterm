...
document.addEventListener('DOMContentLoaded', function () {
    ...
    for(let b =0;b<birds.length;b++){
        birds[b].style.right = (articles[b].offsetWidth / 2 - 300) + "px";
        birds[b].style.top = (articles[b].offsetHeight - 920 - screen.height/ 100) + "px";
    }
    ...
    $(window).on('scroll',function(){
        ...
        /*
        var lines = document.getElementsByClassName("borderLine");
        lines[0].style.height = (document.body.scrollHeight - Bannerimg.offsetHeight-5) + "px";
        lines[1].style.height = (document.body.scrollHeight - Bannerimg.offsetHeight-5) + "px";
        */
    });
